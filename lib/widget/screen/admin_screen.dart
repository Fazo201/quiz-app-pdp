...
class _AdminScreenState extends State<AdminScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.lD9D9D9,
      appBar: AppBar(
      ...
      body: StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> streamSnapshot) {
          if (streamSnapshot.hasData) {
            final List<DocumentSnapshot> items = streamSnapshot.data!.docs.where((doc) => doc['question'].toLowerCase().contains(searchText.toLowerCase())).toList();
